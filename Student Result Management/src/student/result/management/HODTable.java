 ...
 * @author Admin
 */
public class HODTable extends javax.swing.JFrame {

    /**
     * Creates new form HODTable
     */
    public HODTable() {
        initComponents();
    }
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        try{
            ...
            ResultSet rs= st.executeQuery("select * from srms_hod");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HODTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
