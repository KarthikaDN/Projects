 ...
 * @author Admin
 */
public class HODECEresults extends javax.swing.JFrame {

    /**
     * Creates new form HODECEresults
     */
    public HODECEresults() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "EC" }));
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jTextFielddb, javax.swing.GroupLayout.DEFAULT_SIZE, 153, Short.MAX_VALUE)
                                    .addComponent(jTextFieldatc, javax.swing.GroupLayout.DEFAULT_SIZE, 153, Short.MAX_VALUE)
                                    .addComponent(jTextFieldpy))
                                .addGap(53, 53, 53)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        String rollno=jTextFieldrn.getText();
         String name=jTextField1.getText();
          String branch="EC";
        String ec1=(jTextFielddb.getText());
        String ec2=(jTextFieldcns.getText());
        String ec3=(jTextFieldatc.getText());
        String ec4=(jTextFieldunix.getText());
        String ec5=(jTextFieldpy.getText());
        String ec6=(jTextFieldjava.getText());
        if((rollno.equals("")) || (name.equals("")) || (ec1.equals("")) || (ec2.equals("")) || (ec3.equals("")) || (ec4.equals("")) || (ec5.equals(""))|| (ec6.equals(""))){
        ...
        try{
            ...
            ResultSet rs1= st.executeQuery("select * from resultece where rollno='"+rollno+"'");
            if(rs1.next()){
                ...
                try{
                    ...
                    if(rs.next()){
                        st.executeUpdate("insert into resultece (rollno,name,branch,ec1,ec2,ec3,ec4,ec5,ec6) values ('"+rollno+"','"+name+"','"+branch+"','"+ec1+"','"+ec2+"','"+ec3+"','"+ec4+"','"+ec5+"','"+ec6+"')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HODECEresults.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
